...
Sin embargo, si consideramos el Teorema Central del Límite, al poseer un número de observaciones
más alto que 30 podemos considerar que los atributos siguen una distribución normal.
...
disponibles no cumplen con la condición de normalidad, si tener en cuenta el TCL.
